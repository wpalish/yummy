...
"💵 Оплата на месте при получении":"💵 Алу кезінде орнында төлеу",
"Бокс закрепим за вами. Оплатите на кассе, когда придёте забирать.":"Боксты сізге бекітеміз. Алуға келгенде кассада төлеңіз.",
"Ничего не нашлось. Попробуй другой район или категорию 🌙":"Ештеңе табылмады. Басқа аудан не санатты көріңіз 🌙",
"Боксов пока нет — подключаем первые заведения.":"Бокстар әзірге жоқ — алғашқы орындарды қосудамыз.",
"Мы в Астане только запускаемся. Подпишитесь, и вы узнаете о первых боксах раньше всех.":"Біз Астанада енді іске қосылып жатырмыз. Жазылыңыз, алғашқы бокстар туралы бәрінен бұрын білесіз.",
"💬 Сообщить, когда появятся":"💬 Пайда болғанда хабарлау",
"📍 Предложить своё любимое место":"📍 Сүйікті орныңызды ұсыну",
...
"Забронируй":"Броньда","Получишь код и QR для выдачи. Состав бокса — приятный сюрприз.":"Алу үшін код пен QR аласың. Бокстың құрамы — жағымды сюрприз.",
...
"Приём платежей у партнёров":"Серіктестердегі төлем қабылдау",
...
"Кофейням и пекарням Астаны":"Астананың кофеханалары мен наубайханаларына",
"Вечерние списания превращаем в выручку":"Кешкі шығындарды табысқа айналдырамыз",
"Оставить заявку":"Өтінім қалдыру","Три действия, всё с телефона":"Үш әрекет, бәрі телефоннан",
"Что обычно спрашивают":"Әдетте не сұрайды","Это не уронит наш бренд?":"Бұл брендімізге зиян тигізбей ме?",
"Сколько это стоит?":"Бұл қанша тұрады?","А если покупатель не придёт?":"Ал сатып алушы келмесе ше?",
"Сколько времени это отнимает?":"Бұл қанша уақыт алады?",
"Мы почти ничего не списываем":"Біз дерлік ештеңе шығынға жазбаймыз",
"Попробуем на одной точке?":"Бір нүктеде байқап көрейік пе?",
"Вечером выставляете бокс":"Кешке боксты шығарасыз","Покупатель платит онлайн":"Сатып алушы онлайн төлейді",
"Выдаёте по коду":"Код бойынша бересіз","Заявка на подключение":"Қосылуға өтінім",
"Название заведения":"Мекеме атауы","Телефон или WhatsApp":"Телефон немесе WhatsApp",
"комиссия, и только с проданного":"комиссия, тек сатылғаннан",
"подключение и абонплата":"қосылу және абоненттік төлем",
"выставить бокс с телефона":"телефоннан бокс шығару",
"Оформление заказа":"Тапсырысты рәсімдеу","← Назад к боксам":"← Бокстарға оралу",
"Способ оплаты":"Төлем тәсілі","Детали самовывоза":"Өзі алып кету мәліметтері",
"Время выдачи":"Беру уақыты","Ваши контакты":"Сіздің байланыстарыңыз","Ваш заказ":"Сіздің тапсырысыңыз",
"Цена бокса":"Бокс бағасы","Обычная стоимость":"Әдеттегі құны","Экономия":"Үнемдеу","Итого":"Барлығы",
"▦ Дашборд":"▦ Дашборд","♡ Избранное":"♡ Таңдаулылар","⚙ Настройки":"⚙ Баптаулар",
"🧾 Мои заказы":"🧾 Менің тапсырыстарым","Мой вклад":"Менің үлесім","Последние заказы":"Соңғы тапсырыстар",
"№ заказа":"Тапсырыс №","Заведение":"Мекеме","Статус":"Мәртебе","Забрать":"Алу","Действие":"Әрекет",
"Показать код":"Кодты көрсету","Заказов пока нет.":"Әзірге тапсырыс жоқ.",
"сэкономлено на боксах":"бокстарда үнемделді",
"Нет сохранённых заведений. Нажмите ♥ на карточке бокса.":"Сақталған мекеме жоқ. Бокс картасындағы ♥ басыңыз.",
"Сортировать":"Сұрыптау","Сначала дешёвые":"Алдымен арзандары","Больше скидка":"Жеңілдігі көбірек",
"Скоро забирать":"Жақында алу керек","Ближе ко мне":"Маған жақынырақ",
"📍 Моё местоположение":"📍 Менің орналасқан жерім","Забронировать":"Брондау","Вы здесь":"Сіз осындасыз",
"Определяем ваше местоположение…":"Орналасқан жеріңізді анықтаудамыз…",
"Местоположение определено 📍":"Орналасқан жер анықталды 📍",
"Не удалось получить местоположение — разрешите доступ в браузере":"Орналасқан жерді алу мүмкін болмады — браузерде рұқсат беріңіз",
"Геолокация не поддерживается браузером":"Браузер геолокацияны қолдамайды",
"К вечеру в любимых кофейнях остаётся свежая выпечка. Забирай её со скидкой — и ничего не пропадёт впустую.":"Кешке қарай сүйікті кофеханаларда жаңа нан-тоқаш қалады. Оны жеңілдікпен алып кет — ешнәрсе босқа кетпейді.",
"Бесплатно, без подписок и абонплаты":"Тегін, жазылымсыз және абоненттік төлемсіз",
"Оплата онлайн — код и QR сразу после оплаты":"Онлайн төлем — код пен QR төлемнен кейін бірден",
"Забираешь в тот же вечер, рядом с домом":"Сол кештің өзінде, үйдің жанынан алып кетесің",
"до −70%":"−70%-ға дейін",
