...
const LEGAL={
 offer:["Публичная оферта",`<p style="color:var(--txt2);font-size:.8rem"><i>Рабочая редакция. Перед публичным применением проверяется юристом РК. Полный текст — в репозитории (/legal/oferta.md).</i></p>
  <p><b>1. Предмет.</b> Yummy — информационная витрина: показывает сюрприз-боксы из свежих непроданных за день товаров и позволяет их забронировать. Продавцом выступает Заведение. Yummy не является стороной купли-продажи и не принимает оплату за товар.</p>
  <p><b>2. Бронь и оплата.</b> Бронь бесплатна. Оплата — напрямую Заведению при получении, по его правилам. Yummy денег покупателя не касается и вознаграждения из них не удерживает.</p>
  ...
  <p><b>4. Отмена.</b> Не пришли в окно — бронь сгорает, но вы ничего не теряете: предоплаты нет. Заведение не выдало забронированное — сообщите нам, разберёмся; при систематических срывах отключаем от сервиса. Претензия к качеству решается с Заведением как с продавцом.</p>
 ...
 privacy:["Политика конфиденциальности",`<p style="color:var(--txt2);font-size:.8rem"><i>Составлена с опорой на Закон РК «О персональных данных» № 94-V. Рабочая редакция, /legal/privacy.md.</i></p>
  ...
  <p><b>3. Передача.</b> Заведению — имя и телефон только по подтверждённой броне. Провайдеру — сумма платежа. Третьим лицам не передаём и не продаём.</p>
 ...
 agreement:["Договор с заведением",`<p style="color:var(--txt2);font-size:.8rem"><i>Договор возмездного размещения. Рабочая редакция, проверяется юристом РК. /legal/partner-agreement.md.</i></p>
  <p><b>Модель.</b> Yummy — витрина: размещает бренд Заведения и его боксы, приводит гостей. Заведение — продавец. <b>Комиссии с продаж нет:</b> деньги покупателя идут Заведению целиком и напрямую, Сервис их не принимает и не удерживает.</p>
  <p><b>Стоимость размещения.</b> Ежемесячная плата за каждую точку по тарифной лестнице: чем больше точек, тем дешевле точка. <b>Пока Сервис приводит меньше 50 выданных заказов в месяц на точку — размещение бесплатное.</b> Считаются только фактически выданные по коду заказы; обе стороны видят это число в кабинете. Выплат от Сервиса Заведению не бывает — выручка и так у Заведения.</p>
  ...
  <p><b>Обязанности сервиса.</b> Работа платформы и витрины, размещение бренда, отчёт по броням и выдачам, неразглашение данных.</p>
  <p><b>Споры.</b> Обоснованная жалоба гостя → объяснение Заведения и решение вопроса на его стороне (деньги у него). Систематические нарушения → приостановка размещения. Расторжение — с уведомлением за 7 дней, без штрафов.</p>`],
};
