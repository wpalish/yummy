...
class Store:
    ...
    # ------------------------------------------------------------------ #
    # Комиссии в модели Yummy НЕТ: деньги за бокс идут заведению целиком, сервис
    # зарабатывает на платном размещении бренда. Ноль по умолчанию — страховка:
    # если когда-нибудь включат онлайн-оплату, партнёрам не начнёт молча капать
    # долг, которого мы им не обещали. Механизм оставлен рабочим на случай, если
    # модель снова изменится, но включать ставку теперь нужно осознанно.
    _DEFAULT_RATE_BPS = 0
